...
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇQᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    CUDNT_FND = """لم استطع ملفات لطلبك  {}
هل قصدت إحدى هذه النتائج؟"""

    I_CUDNT = """<b>لم استطع ايجاد اي ملفات لطلبك {} 😕

 تأكد من الاسم من جوجل واطلبه بالاسم الصحيح 🙂

استنا الأدمن 😁
 </b>"""

    I_CUD_NT = """لم استطيع اي شي مثل {}.
تحقق من الاسم بشكل صحيح..."""

    MVE_NT_FND = """لا يوجد ملفات لطلبك 😔"""

    TOP_ALRT_MSG = """يتم البحث ..."""

    MELCOW_ENG = """<b>مرحبا {} 😍, واهلا بك في {}  ❤️</b>"""
...
اذا كنت لا ترى طلبك هنا استخدم زر التالي Next"""
...
🎭 النوع: {genres}
📆 العام: <a href={url}/releaseinfo>{year}</a>
...
وقت الإستجابة : {remaining_seconds} <i>seconds</i> 🔥

صاحب الطلب  : {message.from_user.mention}</b>"""

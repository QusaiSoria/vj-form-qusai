...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6303297959').split()]

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002457319504').split()]
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '3d378025a507c11864448667d80c3cfb68194e2a')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/MosalsalatSoriaKadema101/316')
...
MSG_ALRT = environ.get('MSG_ALRT', 'يا مرحبا ومية هلا 💚')
